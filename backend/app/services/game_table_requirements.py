...
class GameTableRequirementsError(RuntimeError):
    """Raised when persisted Table state cannot produce valid requirements."""
...
def evaluate_requirements_snapshot(
    ...
    *,
    ...
    """Pure requirements calculation from authoritative snapshot values."""
...
__all__ = [
    ...
    "evaluate_game_table_requirements",
