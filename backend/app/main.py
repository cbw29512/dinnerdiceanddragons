...
from app.api.routes.event_formation import router as event_formation_router
...
def create_app() -> FastAPI:
    ...
    try:
        ...
        application.include_router(event_formation_router, prefix="/api/v1")
        application.include_router(event_registrations_router, prefix="/api/v1")
