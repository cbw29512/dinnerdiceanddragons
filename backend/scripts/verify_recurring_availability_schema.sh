...
owner_columns="$(psql_scalar "SELECT COUNT(*) FROM information_schema.columns WHERE table_schema='public' AND table_name='recurring_availability_rules' AND column_name IN ('owner_type','owner_id')")"
...
assert_rejected \
  "blank timezone" \
  "INSERT INTO recurring_availability_rules (id,day_of_week,start_time,end_time,pattern_type,week_interval,timezone) VALUES ('00000000-0000-0000-0000-000000000815','sunday','18:00','21:00','weekly_interval',1,'   ')"

assert_rejected \
  "end time before start time" \
  "INSERT INTO recurring_availability_rules (id,day_of_week,start_time,end_time,pattern_type,week_interval,timezone) VALUES ('00000000-0000-0000-0000-000000000816','sunday','22:00','18:00','weekly_interval',1,'America/New_York')"
